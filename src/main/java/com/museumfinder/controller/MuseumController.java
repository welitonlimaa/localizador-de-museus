...
import static com.museumfinder.util.ModelDtoConverter.dtoToModel;

import com.museumfinder.dto.MuseumCreationDto;
import com.museumfinder.dto.MuseumDto;
import com.museumfinder.model.Coordinate;
import com.museumfinder.model.Museum;
import com.museumfinder.service.MuseumServiceInterface;
import com.museumfinder.util.ModelDtoConverter;
...
public class MuseumController {
  ...
  public ResponseEntity<MuseumDto> createMuseum(@RequestBody MuseumCreationDto newMuseum) {
    Museum createdMuseum = museumService.createMuseum(ModelDtoConverter.dtoToModel(newMuseum));

    return ResponseEntity.status(HttpStatus.CREATED).body(ModelDtoConverter.modelToDto(createdMuseum));
  }
